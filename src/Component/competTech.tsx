...
export default function CompetTech() {
          ...
          <AccordionItem>
            <h2>
              <AccordionButton>
                ...
                <Heading as="h3">Mes Compétences techniques</Heading>
                </Box>
                <AccordionIcon />
              </AccordionButton>
            </h2>
            <AccordionPanel pb={4}>
                <p>Gérer une activité digitale développer un projet e-business</p>
                <p>Communiquer une offre commercial</p>
                <p>Communication sur les réseaux sociaux</p>
                <p>Analyse, sens de l'approche client</p>
                <p>Méthodes de communication</p>
                <p>Communication éditoriale, audiovisuelle</p>
                <p>Création visuelles</p>
                <p>Capacité travail en transversal - multi équipes</p>
           </AccordionPanel>
          </AccordionItem>
